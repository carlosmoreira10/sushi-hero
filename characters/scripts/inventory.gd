...
func add_item(_item: Dictionary) -> void:
	...
	_inventory_aux[_item["item_name"]] = _inventory[_item["item_name"]].duplicate(true)#true - recebe os subgrupos do dicionario
...
func remove_item(_item_name: String) -> void:#remover dicionario referente ao slot

...
var _chair_position: Array = [#posicoes das cadeiras
	Vector3(0, 0, 2),
	Vector3(2, 0, 0),
	Vector3(-2, 0, 0),
	Vector3(0, 0, -2)
...
var _angle_rotation: Array = [#posicao do cliente olhando para mesa
	0,
	PI/2,
	-PI + PI/2,
	PI
...
func is_available(_entity) -> void:#erro funcao com _
